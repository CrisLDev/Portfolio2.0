...
export type TecnologiesAction = setTecnologiesAction | SetErrorAction | SetSuccessAction | setLoadingTecnologyAction |  setRegisterTecnologyAction | setRegisterTecnologyFailAction | setGetTecnologiesFailAction;